...
function CatIcon({ sleeping }: { sleeping: boolean }) {
  const mode = sleeping ? "sleep" : "awake";
  ...
  return (
    ...
    >
      <style>{`
        .footer-ear-left-${mode},
        .footer-ear-right-${mode} {
        ...
        @keyframes blinkEye {
          ...
          23%, 50% { transform: scaleY(1); }
          52% { transform: scaleY(0.1); }
          56%, 90% { transform: scaleY(1); }
          100% { transform: scaleY(1); }
        }
        .footer-eye-look-left { animation: lookLeftEye 5s ease-in-out infinite; }
        .footer-eye-look-right { animation: lookRightEye 5s ease-in-out infinite; }
        .footer-eye-blink {
      ...
      <g transform="translate(6, 8)">
        <g transform={sleeping ? "rotate(-15, 7, 10) translate(0, 1)" : undefined}>
          <path
            className={`footer-ear-left-${mode}`}
        ...
        <g transform={sleeping ? "rotate(15, 19, 10) translate(0, 1)" : undefined}>
          <path
            className={`footer-ear-right-${mode}`}
        ...
        {sleeping ? (
          ...
          <>
            <g className="footer-eye-look-left">
              <rect
                className="footer-eye-blink"
                fill="currentColor"
                x="6.477"
                y="18.666"
                width="3.6"
            ...
            <g className="footer-eye-look-right">
              <rect
                className="footer-eye-blink"
                fill="currentColor"
                x="18.078"
      ...
      {sleeping ? (
        ...
        >
          <g
            style={{
              animation: "zFloat1 3s ease-out infinite",
          ...
          <g
            style={{
              animation: "zFloat2 3s ease-out infinite 1s",
              animationFillMode: "both",
            }}
            strokeWidth="1.3"
          >
          ...
          <g
            style={{
              animation: "zFloat3 3s ease-out infinite 2s",
              animationFillMode: "both",
            }}
            strokeWidth="1.1"
          >
            <path d="M36 1 L38.4 1 L36 3.4 L38.4 3.4" />
          </g>
        </g>
      ) : null}
    </svg>
