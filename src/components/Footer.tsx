...
function formatLosAngelesTime(date: Date) {
...
export function Footer() {
  ...
  useEffect(() => {
    const updateTime = () => setTime(formatLosAngelesTime(new Date()));
    updateTime();
  ...
  return (
    <footer className="site-footer">
      ...
      <div className="row">
        <p>
          <span className={`clock${time ? " is-ready" : ""}`}>
            {time ?? "12:00am"} in Los Angeles, California
          </span>{" "}
          <span className={`mascot${time ? " is-ready" : ""}`}>
            <CatIcon />
          </span>
        </p>
      </div>
