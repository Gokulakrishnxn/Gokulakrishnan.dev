...
export const examples: Registry["items"] = [
  ...
  {
    name: "ai-chat-interface-demo",
    type: "registry:example",
    registryDependencies: ["@ncdai/ai-chat-interface"],
    files: [
      {
        path: "examples/ai-chat-interface-demo.tsx",
        type: "registry:example",
      },
    ],
  },
  {
    name: "ai-prompt-builder-demo",
    type: "registry:example",
    registryDependencies: ["@ncdai/ai-prompt-builder"],
    files: [
      {
        path: "examples/ai-prompt-builder-demo.tsx",
        type: "registry:example",
      },
    ],
  },
  {
    ...
    type: "registry:example",
    registryDependencies: ["@ncdai/token-counter"],
    files: [
      {
        path: "examples/token-counter-demo.tsx",
        type: "registry:example",
      },
    ],
  },
