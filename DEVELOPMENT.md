...
```bash
git clone https://github.com/Gokulakrishnxn/gokulakrishnan.dev.git minimal-dev-portfolio
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [gokulakrishnan.dev/components](https://gokulakrishnan.dev/components) for installation instructions and component documentation.
